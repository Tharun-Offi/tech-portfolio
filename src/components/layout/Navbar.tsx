  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        >
          <div className="relative w-10 h-10 rounded-xl p-[1.5px] bg-gradient-to-tr from-cyan-500 via-sky-500 to-purple-600 shadow-[0_0_15px_rgba(6,182,212,0.4)] group-hover:shadow-[0_0_25px_rgba(168,85,247,0.6)] transition-all duration-300">
            <img
              src="/avatar.jpg"
          ...
          <div className="flex flex-col">
            <span className="font-bold tracking-tight text-white flex items-center gap-1.5 text-sm sm:text-base">
              Tharun Murugavel
        ...
        <div className="hidden sm:flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r from-cyan-500 to-purple-600 text-xs font-semibold text-white shadow-[0_0_15px_rgba(6,182,212,0.3)] hover:shadow-[0_0_25px_rgba(6,182,212,0.5)] hover:scale-[1.02] active:scale-[0.98] transition-all cursor-pointer"
          >
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="md:hidden bg-slate-950/95 border-b border-cyan-500/20 backdrop-blur-2xl overflow-hidden px-4 pt-3 pb-6"
          >
            <div className="flex flex-col gap-2">
              ...
              <div className="pt-2 border-t border-slate-800 flex items-center justify-between">
                <button
                  ...
                  className="w-full py-2.5 rounded-xl bg-gradient-to-r from-cyan-500 to-purple-600 text-center text-sm font-semibold text-white"
                >
                  View Full Resume
                </button>
              </div>
